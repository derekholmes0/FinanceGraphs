...
|Parameter call|Subparameter|Feature|
|:-------|:-------|:--------|
...
```{r}
head(ratings_db,3) |> as.data.table()
...
fg_get_colors("lines",n_max=4) |> as.data.frame()
```
...
fg_get_colors("lines",n_max=2) |> as.data.frame()
```
...
tail(newevents,2) |> as.data.frame()
```
